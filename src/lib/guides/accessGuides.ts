...
export const accessGuides: Guide[] = [
  ...
  // ============================================
  {
    ...
    relatedGuides: ['home-access-setup', 'two-factor-login'],
    faq: [
      {
  ...
  // ============================================
  // GUIDE 6: FEILSØKING (TROUBLESHOOTING)
  // ============================================
  {
    id: 'feilsøking',
    ...
    relatedGuides: ['pålogging', 'gatgo-mobile-setup'],
    faq: [
      {
