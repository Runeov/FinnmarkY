...
function GuideComponent({ guide, showHeader = true, defaultExpanded = true }: GuideProps) {
...
export default function Page() {
  const guide = getGuideById('remote-login');

  if (!guide) {
    return <div className="p-6">Veiledning ikke funnet</div>;
  }

  return <GuideComponent guide={guide} />;
}